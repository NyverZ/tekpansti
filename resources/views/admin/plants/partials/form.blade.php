<div class="grid gap-6 md:grid-cols-2">
    <div>
        <label for="local_name" class="mb-2 block text-sm font-semibold text-slate-700">Nama bahan pangan</label>
    ...
    <div>
        <label for="scientific_name" class="mb-2 block text-sm font-semibold text-slate-700">Nama ilmiah</label>
...
<div class="grid gap-6 md:grid-cols-2">
    <div>
        <label for="health_benefits" class="mb-2 block text-sm font-semibold text-slate-700">Nutrisi / manfaat</label>
    ...
    <div>
        <label for="processing_potential" class="mb-2 block text-sm font-semibold text-slate-700">Catatan penanganan / pengolahan</label>
...
<div>
    <label for="image" class="mb-2 block text-sm font-semibold text-slate-700">Unggah gambar</label>
