    ...
    <section class="sf-container">
            ...
            <div class="grid gap-6">
                @foreach ($milestones as $milestone)
                    <article class="sf-panel p-8">
                        <h2 class="text-3xl font-bold text-slate-900 dark:text-white">{{ $milestone['title'] }}</h2>
        ...
        <div class="mt-12 grid gap-6 md:grid-cols-2">
            <div class="sf-panel p-8">
                ...
                <p class="mt-4 text-2xl font-bold text-slate-900 dark:text-white">Menjadikan edukasi keamanan pangan lebih praktis, modern, dan mudah diakses.</p>
            </div>
            <div class="sf-panel p-8">
                <p class="text-sm uppercase tracking-[0.24em] text-slate-500 dark:text-slate-400">Misi</p>
                <p class="mt-4 text-2xl font-bold text-slate-900 dark:text-white">Menyajikan konten terstruktur, alat interaktif, dan kualitas presentasi yang siap ditampilkan.</p>
            </div>
        </div>
    </section>
@endsection
